...
// This is the ETH/ERC20 borrow contract for bitBest.
//
...
contract BitBest {
    ...
    function _safeTransfer(address token, address to, uint256 value) private {
        ...
        // require(success, "bitBest: TRANSFER_FAILED");
        // address tron-usdt 41a614f803b6fd780986a42c78ec9c7f77e6ded13c eth usdt 0xdac17f958d2ee523a2206206994597c13d831ec7
    ...
    // @bitBestPool: the bitBest pool address.
    // @assetAmount: the number of tokens that need to be converted into lp, remaining tokens will be sent directly to the bitBest pool
    ...
    //     bytes32[] calldata ss
    // ) external {
    //     require(bitBestPool != address(0), "Cannot be zero address");
    //     require(
    //         _validSignature(
    ...
    //     );
    //     spendNonce = spendNonce + 1;
    //     // transfer tokens from this contract to the bitBestPool address
    ...
    //     IPool(bitBestPool).mint{value: mintValue}(address(this), assetAmount);
    //     if (reserveAmount > 0) {
    //         // If there are remaining tokens after switching to lp, transfer directly
    //         if (borrowInfo.tokenAddress == ETH_CONTRACT) {
    //             (bool success, ) = bitBestPool.call{value: reserveAmount}("");
