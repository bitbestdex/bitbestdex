...
import {BSTToken} from "./BSTToken.sol";


/**
 * @title BitBestPool contract
 *
 * @notice Main point of interaction with an BitBest protocol's market
 * - Users can:
 *   # Supply
 *   # Withdraw
 *   # Borrow
 ...
 **/
contract BitBestPool is BSTToken, IPool {
    ...
    function _safeTransferFrom(
        ...
        require(
            success && (data.length == 0 || abi.decode(data, (bool))),
            "BitBestPool: TRANSFER_FROM_FAILED"
        );
    }
